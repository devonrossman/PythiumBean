...
fit2 <- lmer(rtwghttrial ~ Title*Var + (1|Iso:Title)+(1|Trial:Set), data=Y3)
fit3 <- lmer(rtwghttrial ~ Title*Var + (1|Iso/Title/Set), data=Y3)
fit4 <- lmer(rtwghttrial ~ Title*Var + (1|Iso/Title:Trial/Set), data=Y3)
fit5 <- lmer(rtwghttrial ~ Title*Var + (1|Iso/Title/Trial:Set), data=Y3)
...
fit2 <- lmer(rtareatrial ~ Title*Var + (1|Iso:Title)+(1|Trial:Set), data=Y3)
fit3 <- lmer(rtareatrial ~ Title*Var + (1|Iso/Title/Set), data=Y3)
fit4 <- lmer(rtareatrial ~ Title*Var + (1|Iso/Title:Trial/Set), data=Y3)
fit5 <- lmer(rtareatrial ~ Title*Var + (1|Iso/Title) + (1/Set), data=Y3)
a<-anova(fit,fit1,fit2,fit3,fit4,fit5)
print(a)
...
fit2 <- lmer(rtlngthtrial ~ Title*Var + (1|Iso:Title)+(1|Trial:Set), data=Y3)
fit3 <- lmer(rtlngthtrial ~ Title*Var + (1|Iso/Title/Set), data=Y3)
fit4 <- lmer(rtlngthtrial ~ Title*Var + (Rep/Trial) + (1|Iso/Title/Set), data=Y3)
fit5 <- lmer(rtlngthtrial ~ Title*Var + (1|Iso/Title/Trial:Set), data=Y3)
a<-anova(fit,fit1,fit2,fit3,fit4,fit5)
print(a)
...
fit2 <- lmer(rtarea ~ Title*Var + (1|Iso/Title/Trial/Set), data=Y3)
