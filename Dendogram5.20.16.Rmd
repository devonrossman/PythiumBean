...
Y3$Set<-as.character(Y3$Set)
Y3$Trial<-as.character(Y3$Trial)
fitwght <- lmer(rtwghttrial ~ Title*Var + (1|Iso/Title/Set), data=Y3)
fitarea <- lmer(rtareatrial ~ Title*Var + (1|Iso/Title/Set), data=Y3)
fitlngth <- lmer(rtlngthtrial ~ Title*Var + (1|Iso/Title/Set), data=Y3)
fitemerge <- lmer(emergetrial ~ Title*Var + (1|Iso/Title/Set), data=Y3)
ls1<-lsmeans(fitwght, contrast(trt.vs.ctrl, fitwght@frame$Title, ref=1)  ~ Title:Var)
ls2<-lsmeans(fitarea, contrast(trt.vs.ctrl, fitarea@frame$Title, ref=1)  ~ Title:Var)
ls3<-lsmeans(fitlngth, contrast(trt.vs.ctrl, fitlngth@frame$Title, ref=1)  ~ Title:Var)
ls4<-lsmeans(fitemerge, contrast(trt.vs.ctrl, fitemerge@frame$Title, ref=1)  ~ Title:Var)
wght1<-summary(ls1)
area1<-summary(ls2)
lngth1<-summary(ls3)
emerge1<-summary(ls4)
