...
geom_errorbar(limits, width=0.2, position=position_dodge(width=0.5))+
  ...
  theme(axis.text.x=element_text(angle=90, hjust=1, vjust=0.5), legend.text=element_text(angle=90), legend.text.align=0.5, legend.title=element_text(angle=90), legend.title.align=0.5, legend.position="bottom", axis.text.y=element_text(angle=90, hjust=0.5, vjust=1))
```
