...
y+geom_point(aes(x=reorder(Title, -mean), color=mean+(SE*1.96)<82), stat="identity", size=1.5)+
  ...
  theme_light()+
labs(title="Emergence", x="Pythium spp.", y="Percent Relative to NIC")+
...
y+geom_point(data=Yrtwght, aes(x=reorder(Title, -mean), color=mean+(SE*1.96)<82), stat="identity", size=1.5)+
  geom_point(data=Yrtlngth, aes(x=reorder(Title, -mean), color=mean+(SE*1.96)<82), stat="identity", size=1.5)+
    geom_point(data=Yrtarea, aes( x=reorder(Title, -mean), color=mean+(SE*1.96)<82), stat="identity", size=1.5)+
  geom_errorbar(limits, stat="identity", width=0.4)+
  facet_grid(Data~.)+
  theme_light()+
...
y+geom_point(data=RHlsmeans, aes(color=(lsmean<.55)), stat="identity", size=1.5)+
  geom_point(data=Zlsmeans, aes(color=(lsmean<.30)), stat="identity", size=1.5)+
